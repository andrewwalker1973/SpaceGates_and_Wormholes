...
public class StateManger : MonoBehaviour
{
  ...
  public static int NumberOfPlayersStillPlaying = 4; // used to count how many still on the board
    ...
    // count turns 
    public int turn_count_advert = 0;
 ...
 public   Camera ThePlayer2_camera;
    ...
    private void RequestInterstitial()
    {
        ...
        // Live AD ID ca-app-pub-5267937863402323/1373471476
        // Test AD ID ca-app-pub-3940256099942544/1033173712
#if UNITY_ANDROID
        string adUnitId = "ca-app-pub-5267937863402323/1373471476";
#elif UNITY_IPHONE
    ...
    public string[] ChanceCards1 =
   {
    ...
    public void NewTurn()
    {
        ...
        Debug.Log("turn count " + turn_count_advert);

        if (turn_count_advert == 30)
        {
            // Debug.Log("Execute add here " + turn_count_advert);
            // Advertisement.Show();

            Debug.Log("at 30");
            if (this.interstitial.IsLoaded())
           {
                Debug.Log("shoild show ad");
